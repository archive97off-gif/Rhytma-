...
import echo.music.iad1tya.ui.navigation.destination.library.SpotifyPlaylistImportDestination
...
import echo.music.iad1tya.ui.screen.library.SpotifyPlaylistImportScreen
...
fun AppNavigationGraph(
    ...
    NavHost(
        ...
        composable<SpotifyPlaylistImportDestination> {
            SpotifyPlaylistImportScreen(
                innerPadding = innerPadding,
                navController = navController,
            )
        }
