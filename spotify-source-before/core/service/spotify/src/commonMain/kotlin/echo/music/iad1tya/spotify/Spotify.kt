...
import echo.music.iad1tya.spotify.auth.SpotifyAuth
import echo.music.iad1tya.spotify.model.response.spotify.CanvasResponse
import echo.music.iad1tya.spotify.model.response.spotify.ClientTokenResponse
import echo.music.iad1tya.spotify.model.response.spotify.PersonalTokenResponse
import echo.music.iad1tya.spotify.model.response.spotify.SpotifyLyricsResponse
import echo.music.iad1tya.spotify.model.response.spotify.search.SpotifySearchResponse
...
class Spotify {
    ...
    suspend fun getPlaylist(
        ...
        spotifyClient.getSpotifyPlaylist(playlistId, authToken, offset, limit)
    }
